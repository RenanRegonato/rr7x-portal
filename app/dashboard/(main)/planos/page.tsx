...
const planos = [
  {
    ...
    destaque: false,
    mensagem: 'Olá! Tenho interesse no plano Pontual do Mandor (R$ 3.500 por análise). Podemos conversar?',
    botao:    'Contratar',
  },
  {
    id:       'recorrente',
  ...
  },
  {
    ...
    nome:     'Corporativo',
    valor:    'Sob consulta',
    desc:     'volume ilimitado · sob medida',
    features: ['Ilimitado', 'Instância dedicada', 'Integração via API', 'Gerente dedicado'],
    destaque: false,
    mensagem: 'Olá! Tenho interesse no plano Corporativo do Mandor. Podemos conversar?',
