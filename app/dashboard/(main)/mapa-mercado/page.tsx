    ...
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto', fontFamily: 'system-ui' }}>
      ...
      <div style={{ border: '1px solid #e5e5e5', borderRadius: '6px', padding: '16px', marginBottom: '24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '16px' }}>
          ...
          <div><div style={{ fontSize: '20px', fontWeight: 'bold' }}>⏳</div><div style={{ fontSize: '11px', color: '#999' }}>ETL em progresso</div></div>
        </div>
      </div>

      <div style={{ border: '1px solid #e5e5e5', borderRadius: '6px', padding: '12px' }}>
        <div style={{ fontSize: '13px', color: '#555' }}>
          <strong>ETL em execução:</strong> Dados sendo carregados do Portal CVM. Páginas de busca serão re-habilitadas quando os dados estiverem disponíveis.
        </div>
      </div>
    </div>
  )
